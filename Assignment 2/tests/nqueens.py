...
def construct_standard_queens(complexity=40):
...
def exp_problem_complexity_with_parallel():
    complexity_list = range(30, 120, 30)
...
def run_single_complexity(c):
    problem, init_state = construct_standard_queens(c)
...
def exp_iterations():
    ...
    problem, init_state = construct_standard_queens()
...
def run_nqueens():
    ...
    hyperTester = HyperTester(construct_standard_queens, 'nqueens')
