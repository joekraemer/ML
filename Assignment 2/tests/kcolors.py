...
def construct_standard_kcolors(complexity=20):
...
def exp_problem_complexity_with_parallel():
    complexity_list = range(25, 200, 50)
...
def run_single_complexity(c):
    problem, init_state = construct_standard_kcolors(c)
...
def exp_iterations():
    ...
    problem, init_state = construct_standard_kcolors()
...
def run_kcolors():
    ...
    hyperTester = HyperTester(construct_standard_kcolors, 'kcolors')
