...
class KnapSack(GenericTester):
    ...
    def run_best_ga(self, problem, init_state, curve=True):
        return mlrose_hiive.genetic_alg(problem, max_attempts=1000, max_iters=20000, curve=curve)

    def run_best_mimic(self, problem, init_state, curve=True):
        return mlrose_hiive.mimic(problem, pop_size=500, max_attempts=1000, max_iters=20000,
                                  curve=curve)
